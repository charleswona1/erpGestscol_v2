                                    ...
                                    <tr>
                                        <td>
                                            <div class="position-relative form-group"><label for="exampleSelect"
                                                ...
                                                <select name="niveaux_id" class="form-control" required>
                                        ...
                                        @forelse ($matiere_niveaux as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="mdc-data-table__cell">
                                                    ...
                                                    <a
                                                        href="{{ route('gestscol.parametrage_matiere.edit', $item->id) }}"><i
                                                            class="fas fa-edit"></i></i></a>
                                                    <a href=""><i class="fas fa-print"></i></i></a>
                                                    <a href="{{ route('gestscol.parametrage_matiere.delete', $item->id) }}"
