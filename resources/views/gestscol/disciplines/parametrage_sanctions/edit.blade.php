        ...
        <div class="col-md-12">
            <div class="main-card mb-12 card">
                ...
                <div class="card-body col-md-12">
                    ...
                    @csrf
                    <input type="hidden" value="{{ $parametrageSanction->id_parametrage }}" name="id">
                    <table class="col-md-12">
                        <tr class="col-md-12">
                            <td class="col-md-6">
                                <div class="position-relative form-group"><label for="exampleSelect"
                                        class="">Cycle <span style="color:red;">*</span></label>
                                    <select name="cycle_id" id="exampleSelect" class="form-control" required>
                                        @foreach ($cycles as $cycle)
                                            @if ($cycle->id == $parametrageSanction->cycle()->get()[0]->id)
                                ...
                                <div class="position-relative form-group"><label for="exampleSelect"
                                    ...
                                    <select name="sanction_id" id="exampleSelect" class="form-control"
                                        ...
                                        @foreach ($sanctions as $sanction)
                                            @if ($sanction->id == $parametrageSanction->sanction1()->get()[0]->id)
                                                <option value="{{ $sanction->id }}" selected>
                                                    {{ $sanction->libelle }}</option>
                                            @else
                                                <option value="{{ $sanction->id }}">{{ $sanction->libelle }}
                                                </option>
                                            @endif
                            ...
                            <td class="col-md-6">
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Valeur <span
                                            style="color:red;">*</span></label>
                                    <input name="valeur" value="{{ $parametrageSanction->valeur }}"
                        ...
                        <tr>
                            <td class="col-md-6">
                                <div class="position-relative form-group"><label for="exampleSelect"
                                    ...
                                    <select name="sanction_id2" id="exampleSelect" class="form-control"
                                        required>
                                        @foreach ($sanctions as $sanction)
                                            @if ($sanction->id == $parametrageSanction->sanction2()->get()[0]->id)
                                                <option value="{{ $sanction->id }}" selected>
                                                    {{ $sanction->libelle }}</option>
                                            @else
                                                <option value="{{ $sanction->id }}">{{ $sanction->libelle }}
                            ...
                            <td class="col-md-6">
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Valeur <span
                                            style="color:red;">*</span></label>
                                    <input name="valeur2" value="{{ $parametrageSanction->valeur2 }}"
                                        placeholder="Valeur" type="number" class="form-control" required>
                                </div>
                            </td>
                        </tr>
                            ...
                            @forelse ($parametrage_sanctions as $item)
                                <tr>
                                    ...
                                    <td class="mdc-data-table__cell">
                                        ...
                                        <a
                                            href="{{ route('gestscol.parametragesanctions.edit', [$etablissement, $item]) }}"><i
                                                class="fas fa-edit"></i></i></a>
                                        <a href=""><i class="fas fa-print"></i></i></a>
                                        <a href="{{ route('gestscol.parametragesanctions.delete', [$etablissement, $item]) }}"
